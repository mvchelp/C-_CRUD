<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="EmployeeEntry.aspx.cs" Inherits="EmployeeEntry.EmployeeEntry" %>
...
<div>
    ...
    <table id="tbl_Content" align="left">
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td colspan="2" class="style2">
                <asp:Button ID="btn_Submit" runat="server" Text="Submit" Width="117px" OnClientClick="return Validate()" OnClick="btn_Submit_Click" />
